  ...
  return (
    <div className="container outer-wrapper">
      ...
      <div className="timeline-legend">
        <div>
          <p>
            <span className="trade-ban-item add-padding"></span>ban for trade
          </p>
          <p>
            <span className="farming-ban-item add-padding"></span>ban for
            farming
          </p>
          <p>
            <span className="strict-regulation-item add-padding"></span>strict
            regulations
          </p>
        </div>
      </div>
